...
class Tags(object):
    ...
    @property
    def ram_swap_usage(self):
        return self.RAM_SWAP_USAGE

    @property
    def bandwidth_per_second(self):
        return self.BANDWIDTH_PER_SECOND
